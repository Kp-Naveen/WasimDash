...
const Sidebar = ({ open, setOpen, menus }) => {
  ...
  <div style={{ height: '12px' }} />
        ...
        <NavLink
          ...
          onClick={() => { window.location.pathname = menu?.nav }}
          id={window.location.pathname === menu?.nav ? "active" : null}
          style={{ backgroundColor: !open && window.location.pathname === menu?.nav ? '#00a727' : '' }}
        >
